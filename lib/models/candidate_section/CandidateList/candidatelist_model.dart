...
List<Candidatelist> candidatelistFromJson(String str) =>
    List<Candidatelist>.from(
        json.decode(str).map((x) => Candidatelist.fromJson(x)));

String candidatelistToJson(List<Candidatelist> data) =>
...
class Candidatelist {
  ...
  factory Candidatelist.fromJson(Map<String, dynamic> json) => Candidatelist(
        ...
        protfoliolink: json["protfoliolink"] == null
            ? []
            : List<About>.from(
                json["protfoliolink"]!.map((x) => About.fromJson(x))),
        careerPreference: json["careerPreference"] == null
            ? []
            : List<CareerPreference>.from(json["careerPreference"]!
                .map((x) => CareerPreference.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "skill": skill == null
            ? []
            : List<String>.from(skill!.map((x) => x)),
        "protfoliolink": protfoliolink == null
            ? []
            : List<dynamic>.from(protfoliolink!.map((x) => x.toJson())),
        "careerPreference": careerPreference == null
            ? []
            : List<dynamic>.from(careerPreference!.map((x) => x.toJson())),
...
class CareerPreference {
  ...
  factory CareerPreference.fromJson(Map<String, dynamic> json) =>
      CareerPreference(
        id: json["_id"],
        userid: json["userid"],
        ...
        functionalarea: json["functionalarea"] == null
            ? null
            : Functionalarea.fromJson(json["functionalarea"]),
        ...
        salaray:
            json["salaray"] == null ? null : Salaray.fromJson(json["salaray"]),
        createdAt: json["createdAt"] == null
            ? null
            : DateTime.parse(json["createdAt"]),
        updatedAt: json["updatedAt"] == null
...
class Division {
  ...
  factory Division.fromJson(Map<String, dynamic> json) => Division(
        ...
        cityid:
            json["cityid"] == null ? null : Subject.fromJson(json["cityid"]),
        createdAt: json["createdAt"] == null
            ? null
            : DateTime.parse(json["createdAt"]),
        updatedAt: json["updatedAt"] == null
...
class Functionalarea {
  ...
  factory Functionalarea.fromJson(Map<String, dynamic> json) => Functionalarea(
        id: json["_id"],
        industryid: json["industryid"] == null
            ? null
            : Industryid.fromJson(json["industryid"]),
...
class Education {
  ...
  factory Education.fromJson(Map<String, dynamic> json) => Education(
        ...
        digree: json["digree"] == null
            ? null
            : Experiencedlevel.fromJson(json["digree"]),
        subject:
...
class Experiencedlevel {
  ...
  factory Experiencedlevel.fromJson(Map<String, dynamic> json) =>
      Experiencedlevel(
        id: json["_id"],
        name: json["name"],
        education: json["education"] == null
            ? null
            : Experiencedlevel.fromJson(json["education"]),
        v: json["__v"],
      );
...
class Userid {
  ...
  factory Userid.fromJson(Map<String, dynamic> json) => Userid(
        ...
        gender: json["gender"],
        experiencedlevel: json["experiencedlevel"] == null
            ? null
            : Experiencedlevel.fromJson(json["experiencedlevel"]),
        startedworking: json["startedworking"] == null
            ? null
            : DateTime.parse(json["startedworking"]),
        deatofbirth: json["deatofbirth"] == null
            ? null
            : DateTime.parse(json["deatofbirth"]),
        email: json["email"],
        image: json["image"],
        createdAt: json["createdAt"] == null
            ? null
...
class Workexperience {
  ...
  factory Workexperience.fromJson(Map<String, dynamic> json) => Workexperience(
        ...
        enddate:
            json["enddate"] == null ? null : DateTime.parse(json["enddate"]),
        expertisearea: json["expertisearea"] == null
            ? null
            : Expertisearea.fromJson(json["expertisearea"]),
...
class Expertisearea {
  ...
  factory Expertisearea.fromJson(Map<String, dynamic> json) => Expertisearea(
        id: json["_id"],
        industryid: json["industryid"],
        categoryid: json["categoryid"],
        functionalname: json["functionalname"],
