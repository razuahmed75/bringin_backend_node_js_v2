...
//
//     final candidateProfileInfoModel = candidateProfileInfoModelFromJson(jsonString);

import 'dart:convert';

CandidateProfileInfoModel candidateProfileInfoModelFromJson(String str) => CandidateProfileInfoModel.fromJson(json.decode(str));

String candidateProfileInfoModelToJson(CandidateProfileInfoModel data) => json.encode(data.toJson());

class CandidateProfileInfoModel {
    Other? other;
    String? id;
    String? number;
    ...
    factory CandidateProfileInfoModel.fromJson(Map<String, dynamic> json) => CandidateProfileInfoModel(
