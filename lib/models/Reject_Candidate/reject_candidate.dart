...
//
//     final rejectCandidate = rejectCandidateFromJson(jsonString);

import 'dart:convert';

List<RejectCandidate> rejectCandidateFromJson(String str) => List<RejectCandidate>.from(json.decode(str).map((x) => RejectCandidate.fromJson(x)));

String rejectCandidateToJson(List<RejectCandidate> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class RejectCandidate {
    String? id;
    String? userid;
    String? candidateid;
    Candidatefullprofileid? candidatefullprofileid;
    DateTime? createdAt;
    DateTime? updatedAt;
    int? v;
    ...
    RejectCandidate({
        ...
        this.userid,
        this.candidateid,
        this.candidatefullprofileid,
        this.createdAt,
        this.updatedAt,
        this.v,
    });

    factory RejectCandidate.fromJson(Map<String, dynamic> json) => RejectCandidate(
        id: json["_id"],
        userid: json["userid"],
        candidateid: json["candidateid"],
        candidatefullprofileid: json["candidatefullprofileid"] == null ? null : Candidatefullprofileid.fromJson(json["candidatefullprofileid"]),
    ...
    Map<String, dynamic> toJson() => {
        ...
        "candidatefullprofileid": candidatefullprofileid?.toJson(),
...
class Candidatefullprofileid {
    ...
    factory Candidatefullprofileid.fromJson(Map<String, dynamic> json) => Candidatefullprofileid(
        id: json["_id"],
