...
//     Personalcontroller personalcontroller, final Salary data) async {
//   final doc = pw.Document(pageMode: PdfPageMode.outlines);
//   final regular = await rootBundle.load("font/Poppins-Regular.ttf");
//   final regularbold = await rootBundle.load("font/Poppins-Bold.ttf");
...
//                     children: [
//                       pw.Text(
//                         "Vaani Techlabs Private Limited",
//                         style: pw.TextStyle(
...
//                         width: 200,
//                         child: pw.Text(
//                           "181/47 Raja Rammohan Roy Road, Kolkata 700041",
//                           style: pw.TextStyle(fontSize: 17.sp),
//                         ),
//                       ),
...
//                       children: [
//                         pw.Text(
//                           "${personalcontroller.userinfo!.user!.name}",
//                           style: pw.TextStyle(
//                               fontSize: 17.sp, fontWeight: pw.FontWeight.bold),
//                         ),
//                         pw.SizedBox(
//                           width: 200,
//                           child: pw.Text(
//                             "${personalcontroller.userinfo!.user!.department}",
//                             style: pw.TextStyle(fontSize: 17.sp),
//                           ),
//                         ),
//                         pw.SizedBox(
//                           width: 200,
//                           child: pw.Text(
//                             "${personalcontroller.userinfo!.user!.designation}",
//                             style: pw.TextStyle(fontSize: 17.sp),
//                           ),
//                         ),
//                         pw.SizedBox(
//                           width: 200,
//                           child: pw.Text(
//                             "Join: ${DateFormat("dd MMM, yyyy").format(personalcontroller.userinfo!.user!.joiningDate!)}",
//                             style: pw.TextStyle(fontSize: 17.sp),
//                           ),
//                         ),
//                       ])
...
//                         data: <List<String>>[
//                           <String>['Name', 'Earning'],
//                           <String>['Basic Salary', '₹${data.basicSalary!}'],
//                           <String>[
//                             'Medical Allowance',
//                             '₹${data.medicalAllowance!}'
//                           ],
//                           <String>['Allowance', '₹${data.allowance!}'],
...
//                   pw.SizedBox(height: 20.h),
//                   pw.Text(
//                     "Net Salary: ₹${data.totalIncome} (${NumberToWord().convert('en-in', int.parse(data.totalIncome!))})",
//                     style: pw.TextStyle(
//                         fontSize: 17.sp, fontWeight: pw.FontWeight.bold),
//                   ),
//                 ],
