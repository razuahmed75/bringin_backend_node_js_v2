...
class RecruiterWhoSavedMeTab extends StatefulWidget {
  const RecruiterWhoSavedMeTab({super.key});

  @override
  State<RecruiterWhoSavedMeTab> createState() => _RecruiterWhoSavedMeTabState();
}

class _RecruiterWhoSavedMeTabState extends State<RecruiterWhoSavedMeTab> {
  ...
  load()async{
    ...
    await CandidateControll.to.getWhoSavedMe();
    setState(() {
      isLoading = false;
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    ) : CandidateControll.to.whoSavedMeList.isEmpty 
    ? EmptyWhoSavedMe(
    ...
    : ListView.builder(
      itemCount: CandidateControll.to.whoSavedMeList.length,
      itemBuilder: (_,index){
      var candidateData = CandidateControll.to.whoSavedMeList[index];
