...
class OfferLetterVerifyScreen extends StatelessWidget {
  const OfferLetterVerifyScreen({super.key});
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text("Upload Offer Letter", style: Styles.smallTitle),
                const Gap(3),
                Text(
                  AppStrings.offerLetterVeifyDes,
            ...
            GetBuilder<UploadRecruiterDocumentController>(builder: (_) {
              if (uploadDocumentController.result != null && uploadDocumentController.fileExtension == '.pdf') {
                return Center(
                  child: Container(
                    height: height(280),
