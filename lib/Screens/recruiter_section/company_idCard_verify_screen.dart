...
class CompanyIdCardVerifyScreen extends StatelessWidget {
  const CompanyIdCardVerifyScreen({super.key});
        ...
        child: Column(
          ...
          children: [
            Dimensions.kDefaultgapTop,
              Text("Upload Company ID Card", style: Styles.smallTitle),
                const Gap(3),
                Text(
                  AppStrings.companyIdCardVeifyDes,
