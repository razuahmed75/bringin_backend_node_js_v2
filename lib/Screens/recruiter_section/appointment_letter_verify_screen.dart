...
class AppointmentLetterVerifyScreen extends StatelessWidget {
  const AppointmentLetterVerifyScreen({super.key});
        ...
        child: Column(
          ...
          children: [
            Dimensions.kDefaultgapTop,
              Text("Upload Appointment Letter", style: Styles.smallTitle),
                const Gap(3),
                Text(
                  AppStrings.appointmentLetterVeifyDes,
