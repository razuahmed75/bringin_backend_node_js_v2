...
class CandidateTotalChatHistoryScreen extends StatelessWidget {
  final String? id;
  const CandidateTotalChatHistoryScreen({super.key, this.id});

  @override
  Widget build(BuildContext context) {
    JobControll.to.getTotalChatHistory(id: id);
            ...
            children: [
              ...
              Obx(
                () => jobControll.isLoading.value
                    ? Helpers.appLoader()
                    : jobControll.totalChatHistoryList.isEmpty
                        ? Container(
                        ...
                        : Expanded(
                            child: Align(
                              ...
                              child: ListView.builder(
                                  ...
                                  reverse: true,
                                  itemCount:
                                      jobControll.totalChatHistoryList.length,
                                  itemBuilder: (_, index) {
                                    var data =
                                        jobControll.totalChatHistoryList[index];
                                    return InkWell(
                                      onTap: () {
